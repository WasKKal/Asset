...
local PRESET_PAGES = {
    {
        ...
        icon = "blocks",
        url = "https://cdn.jsdelivr.net/gh/WasKKal/Asset@latest/deltaui/coding_blocks.lua",
        unsafe = true,
        version = "1.0.0",
    },
    {
        ...
        icon = "shield-check",
        url = "https://cdn.jsdelivr.net/gh/WasKKal/Asset@8dc4ed051575265ed4a6ed28eb8b33fd0e1c2f66/deltaui/deobfuscator.lua",
        unsafe = true,
        version = "1.0.0",
    },
}
...
for i, preset in ipairs(PRESET_PAGES) do
    ...
    local function hasUpdate()
        if not preset.version then return false end
        local localVer = getInstalledPageVersion(preset.name)
        return compareVersions(preset.version, localVer) > 0
    end
